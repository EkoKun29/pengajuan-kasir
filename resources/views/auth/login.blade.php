    ...
    <div class="glass-effect p-8 rounded-2xl shadow-2xl w-full max-w-md fade-in-up">
        ...
        <div class="flex justify-center mb-8 fade-in-up stagger-1">
            <div class="flex items-center space-x-3">
                ...
                <h1 class="text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">CV. Aliansyah</h1>
            </div>
        </div>
...
{{-- 
        ...
        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 rounded-md fade-in-up stagger-3">
            <div class="flex">
