    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                {{-- Search Form --}}
                <form method="GET" action="{{ auth()->user()->role === 'admin' ? route('admin.users.index') : route('admin.users.index') }}" class="flex gap-2">
                    <div class="relative">
                                ...
                                <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="no_wa" value="{{ $user->no_wa ?? '62' }}" class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan nomor WA" required>
                                        </div>
                                    </div>
            ...
            <div class="px-6 py-4">
                <form method="POST" action="{{ route('admin.users.store') }}" id="createForm" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">No. WA</label>
                            <input type="text" name="no_wa" value="{{ old('no_wa', '62') }}" class="w-full border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan nomor WA" required>
                        </div>
                    </div>
                </form>
            </div>
